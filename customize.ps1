Function Customize {
    ...
    Write-Host "Stopping Cortana from being used as part of Windows Search..."
    ...
    Write-Host "Disabling Web Results in Windows Search..."
    ...
    Write-Host "Preventing Web Suggestions in Windows Explorer..."
    If (!(Test-Path "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer")) {
        New-Item -Path "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer" | Out-Null
    }
    Set-ItemProperty -Path "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Name "DisableSearchBoxSuggestions" -Type DWord -Value 1

    Write-Host "Setting Mixed Reality Portal value to 0 so it can be uninstalled in Settings..."
    ...
    # Warning: this command has no undo step in the script
